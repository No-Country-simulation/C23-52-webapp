...
import {
  GetAllTagOutputSchema,
  CreateTagInputBodySchema,
  TagInputPathParamsSchema,
  GetTagOutputSchema,
  UpdateTagInputBodySchema,
...
registry.registerPath({
  ...
  responses: createStandardResponses(
    CreateServerSuccessSchema(GetAllTagOutputSchema),
    "Lista de tags"
  ),
});
...
registry.registerPath({
  ...
  responses: createStandardResponses(
    CreateServerSuccessSchema(GetTagOutputSchema),
    "Tag encontrado"
  ),
});
